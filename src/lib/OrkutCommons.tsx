...
// Menu
// ================================================================================================================
export function OrkutMenu({ githubUser }: any) {
...
type OrkutWrapperType = {
    isMenuOpen: boolean
}
//Thanks to Eduardo Tioma discord: edukure#4734 for helping with this syntax
OrkutMenu.Wrapper = styled.header<OrkutWrapperType>`
    width: 100%;
    background-color: #308bc5;
    .OrkutMenuProfileSidebar {
        background: white;
        position: fixed;
        z-index: 100;
        padding: 46px;
...
function OrkutMenuProfileSidebar({ githubUser }) {
    return (
        <div className="OrkutMenuProfileSidebar">
            <div>
                <img
...
export function OrkutNostalgicIconSet(props) {
    return (
        <OrkutNostalgicIconSet.List>
            ...
            {[
                { name: 'Trusty', slug: 'trusty', icon: 'smile' },
